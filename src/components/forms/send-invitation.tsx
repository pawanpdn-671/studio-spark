...
const SendInvitation = ({ agencyId }: SendInvitationProps) => {
	...
	const onSubmit = async (values: z.infer<typeof userDataSchema>) => {
		try {
			...
			toast({
				variant: "destructive",
				title: "oops!",
				description: "Couldnot send invitation",
			});
		}
	};
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					An invitation will be sent to the user. Users who already have an invitation sent out to their email,
					will not receive another invitation.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<Form {...form}>
