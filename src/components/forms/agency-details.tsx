		...
		<AlertDialog>
			<Card className="mt-2 w-full">
				<CardHeader>
					...
					<CardDescription>
						Lets create an agency for your business. You can edit agency settings later from the agency settings
						tab.
					</CardDescription>
				</CardHeader>
				<CardContent>
									...
									return (
										<FormItem className="flex flex-row items-center justify-between rounded-lg border gap-4 p-4">
											<div>
												...
												<FormDescription>
													Turning on whilelabel mode will show your agency logo to all sub accounts by
					...
					<div className="flex flex-row items-center justify-between rounded-lg border-destructive gap-4 p-4 mt-4">
						...
						<div className="text-muted-foreground">
							Deleting your agency cannpt be undone. This will also delete all sub accounts and all data related
							to your sub accounts. Sub accounts will no longer have access to funnels, contacts etc.
						</div>
						<AlertDialogTrigger
