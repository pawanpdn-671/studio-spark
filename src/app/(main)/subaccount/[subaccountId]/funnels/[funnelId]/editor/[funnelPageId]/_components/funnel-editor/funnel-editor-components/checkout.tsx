...
const Checkout = (props: Props) => {
	...
	const [subAccountConnectedAccId, setSubAccountConnectedAccId] = useState("");
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			if (subaccountDetails) {
				...
				setSubAccountConnectedAccId(subaccountDetails.connectAccountId);
			}
		};
		fetchData();
	}, [subaccountId]);
	...
	useEffect(() => {
		if (livePrices.length && subaccountId && subAccountConnectedAccId) {
	...
	}, [livePrices, subaccountId, subAccountConnectedAccId]);
		...
		<div
			...
			<div className="border-none transition-all w-full">
				<div className="flex flex-col gap-4 w-full">
					{options.clientSecret && subAccountConnectedAccId && (
						<div className="text-white">
							<EmbeddedCheckoutProvider stripe={getStripe(subAccountConnectedAccId)} options={options}>
								<EmbeddedCheckout />
