...
import { Contact2, Edit, Link2, LinkIcon, MoreHorizontal, MoreHorizontalIcon, Trash, User2 } from "lucide-react";
	...
	const handleDeleteTicket = async () => {
		try {
			...
			toast({
				variant: "destructive",
				title: "Oops!",
				description: "Couldn't delete the ticket.",
			});
							...
							<DropdownMenu>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											This action cannot be undone. This will permanently delete the ticket and remove it
											from our servers.
										</AlertDialogDescription>
									</AlertDialogHeader>
